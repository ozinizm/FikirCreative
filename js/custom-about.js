(function($) { "use strict";
	...
	$(function(){"use strict";
		$('.sosyal-top').css({'height':($(window).height())+'px'});
		$(window).resize(function(){
		$('.sosyal-top').css({'height':($(window).height())+'px'});
		});
	});
	$(function(){"use strict";
		$('.video-top').css({'height':($(window).height())+'px'});
		$(window).resize(function(){
		$('.video-top').css({'height':($(window).height())+'px'});
		});
	});
	$(function(){"use strict";
		$('.kurumsal-top').css({'height':($(window).height())+'px'});
		$(window).resize(function(){
		$('.kurumsal-top').css({'height':($(window).height())+'px'});
		});
	});
		$(function(){"use strict";
		$('.marka-top').css({'height':($(window).height())+'px'});
		$(window).resize(function(){
		$('.marka-top').css({'height':($(window).height())+'px'});
		});
	});
	$(function(){"use strict";
		$('.web-top').css({'height':($(window).height())+'px'});
		$(window).resize(function(){
		$('.web-top').css({'height':($(window).height())+'px'});
		});
	});
